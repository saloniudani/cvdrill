...
public class CvDrillWebServer implements AutoCloseable {
  ...
  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory
      .getLogger(CvDrillWebServer.class);
   ...
   */
  public CvDrillWebServer(final DrillConfig config, final MetricRegistry metrics,
  ...
  private ConstraintSecurityHandler createSecurityHandler() {
    ...
    security
        .setLoginService(new CvDrillRestLoginService(workManager.getContext()));
  ...
  public void start() throws Exception {
    ...
    String drillIconResourcePath = Resource
        .newClassPathResource(CvDrillWebServer.BASE_STATIC_PATH + CvDrillWebServer.DRILL_ICON_RESOURCE_RELATIVE_PATH).getURL()
        .toString();
